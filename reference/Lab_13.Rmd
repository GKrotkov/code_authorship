...
# Note that the input documents here are all lower case and have no punctuation.
# This is a requirement of the model we picked, which is small enough by 
# virtue of sacrificing those features.
```
...
@NOTE this down sampling is extremely important for any classification problem with imbalanced classes; if we fail to do this the majority class will always dominate.
